...
INLAY_SHELF_USABLE_X_MIN_MM: float = 8.00
INLAY_SHELF_USABLE_X_MAX_MM: float = 49.40
INLAY_SHELF_USABLE_Y_MIN_MM: float = 10.00
INLAY_SHELF_USABLE_Y_MAX_MM: float = 215.00
INLAY_CENTER_X_MM: float = 28.70
INLAY_MIN_CUTOUT_DIAMETER_MM: float = 5.0
INLAY_MAX_CUTOUT_DIAMETER_MM: float = 45.0
